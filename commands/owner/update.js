...
const DEFAULT_GITHUB_ZIP = 'https://github.com/BTXdqzKp3Lp4rH35Hafl120363/Updator/archive/refs/heads/main.zip';
  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      const req = client.get(url, {
        headers: {
          'User-Agent': 'BTXdqzKp3Lp4rH35Hafl120363-Updater/1.0',
          'Accept': '*/*'
        }
      }, res => {
